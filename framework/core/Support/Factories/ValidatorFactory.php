...
namespace Frameworks\Support\Factories;
...
class ValidatorFactory
{
	 ...
	 * @var string
	 */
	private string $langDir = FRAMEWORKS_THEME_LANG_PATH;
    ...
    {
		$this->langDir = FRAMEWORKS_THEME_LANG_PATH . DIRECTORY_SEPARATOR . $this->group;
