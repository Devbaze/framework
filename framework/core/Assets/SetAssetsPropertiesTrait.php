...
trait SetAssetsPropertiesTrait
{
	...
	{
		return FRAMEWORKS_THEME_PUBLIC_URI . $file;
	}
	...
	{
		if ( file_exists( FRAMEWORKS_THEME_PUBLIC_PATH . $file ) ) {
			return filemtime( FRAMEWORKS_THEME_PUBLIC_PATH . $file );
		}
